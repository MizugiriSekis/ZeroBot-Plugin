...
import (
	...
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/atri" // yusei词库
...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "游星", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:      append([]string{*adana}, "yusei", "蟹哥", "蟹", "不动游星"),
